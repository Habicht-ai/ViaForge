...
import com.viaversion.viaforge.account.Account;
import com.viaversion.viaforge.account.AccountManager;
import com.viaversion.viaforge.account.CookieFolderImporter;
import com.viaversion.viaforge.account.MicrosoftLogin;
import java.io.File;
...
public final class AccountManagerGui extends GuiScreen {
    ...
    public AccountManagerGui(GuiScreen parent, AccountManager accounts) {
        this.parent = parent;
    ...
    @Override protected void actionPerformed(GuiButton button) throws IOException {
        ...
        switch (button.id) {
            case 1:
                ...
                break;
            case 2: mc.displayGuiScreen(new OfflineAccountGui(this, accounts)); break;
            case 3:
    ...
    private void drawAccounts(int mouseX, int mouseY) {
        ...
        if (wide) {
            ...
            } else AccountScreenStyle.rawText(account == null ? "Select a saved account" : account.getName(), railLeft, y + 17, AccountScreenStyle.MUTED);
        }
    }
    ...
    private void drawRemove() {
        ...
        centered("Deletes the saved sign-in from ViaForge.", width / 2, y + 62, AccountScreenStyle.MUTED);
    }
    ...
    private void drawCookieFolder() {
        ...
        String[] lines = {
                ...
                "Drop one Netscape .txt export per account into ViaForge/cookies.",
    ...
    private void openCookieFolder() {
        choosingFile = true;
        chooserMessage = "Opening ViaForge/cookies...";
