...
public final class ClientEventEnvelope {
    ...
    public static ClientEventEnvelope read(ByteBuf input){
        ...
        if(operation>33)throw new IllegalArgumentException("Unknown client event "+operation);
    ...
    public static void write(ByteBuf output,ClientEventFormat format,int operation){
        if(operation<0||operation>33)throw new IllegalArgumentException("Unknown client event "+operation);
